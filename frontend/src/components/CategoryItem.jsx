...
function CategoryItem({item}) {
  ...
  return (
        ...
        >
          ...
          className="absolute h-full w-full top-0 left-0 flex flex-col items-center justify-center mb-2 bg-slate-500 bg-opacity-30 hover: transition-transform ease-linear duration-100">
